...
from math_util import rotation_matrix


# Static constraints computed with DecompUtil
# Constraints of the form Ax <= b (+ slack)
class DecompConstraintModule:

    def __init__(self, settings):
        self.type = "constraint"
        self.n_discs = settings["n_discs"]
        self.max_constraints = settings["decomp"]["max_constraints"]
        self.n_constraints = self.max_constraints * self.n_discs
